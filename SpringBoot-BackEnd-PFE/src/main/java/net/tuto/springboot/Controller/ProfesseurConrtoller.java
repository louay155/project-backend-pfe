...
import net.tuto.springboot.repository.ProfesseurRepository;
...
@RestController
@RequestMapping("/api")
public class ProfesseurConrtoller {
	@Autowired
	...
	public ResponseEntity<Professeur> Updateprofesseur( @PathVariable long id, @RequestBody Professeur professeurDetails){
		...
		professeur.setMontant(professeurDetails.getMontant());
		professeur.setPourcentage(professeurDetails.getPourcentage());
